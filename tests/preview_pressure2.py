...
class PreviewWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.dark = False
        self.setWindowTitle("Preview — PressureWidget2 horizontal")
        ...
        self.widget  = PressureWidget2(monitor=self.monitor, dark=False, parent=self)

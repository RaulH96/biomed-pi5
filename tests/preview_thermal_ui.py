# tests/preview_thermal.py
# Uso: python -m tests.preview_thermal_ui
# Muestra el ThermalWidget con datos reales del sensor, para debug visual.
import sys
...
class PreviewWindow(QWidget):          # QWidget directo, sin QMainWindow
    def __init__(self):
        super().__init__()
        self.dark = False
        self.setWindowTitle("Preview — ThermalWidget")
        ...
        self.thermal = ThermalWidget(driver=MLX90640Driver(), dark=False, offset=offset, parent=self)

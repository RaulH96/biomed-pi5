...
from ui.widgets.spo2_widget import SpO2Widget
...
class PreviewWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.dark = False
        self.setWindowTitle("Preview — SpO2 y Pulso")
        #self.setMinimumSize(400, 480)
        self.setMinimumSize(320, 240)
        self.setAttribute(Qt.WidgetAttribute.WA_StyledBackground, True)
        lay = QVBoxLayout(self)
        lay.setContentsMargins(0, 0, 0, 0)
        self.widget = SpO2Widget(monitor=SpO2Monitor(), dark=False, parent=self)
